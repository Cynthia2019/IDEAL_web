                    ...
                    <div className={styles["data-selector"]}>
                        ...
                        <div className={styles["data-content-line"]}>
                            ...
                            <FormControl variant="standard" fullWidth>
                                ...
                                >
                                    <MenuItem value={"Minimal directional Young's modulus [N/m]"}>Minimal directional
                                        Young's modulus [N/m]</MenuItem>
                                    <MenuItem value={"Maximal directional Young's modulus [N/m]"}>Maximal directional
                                        Young's modulus [N/m]</MenuItem>
                                    <MenuItem value={"Minimal Poisson's ratio [-]"}>Minimal Poisson's ratio
                                        [-]</MenuItem>
                                    <MenuItem value={"Maximal Poisson's ratio [-]"}>Maximal Poisson's ratio
                                        [-]</MenuItem>
                                </Select>
                            </FormControl>
                        </div>
